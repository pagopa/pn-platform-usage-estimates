...
public interface EstimateService {
    ...
    Mono<InfoDownloadDTO> downloadEstimateFileTarget(String paId, String reportKey);
    Mono<InfoDownloadDTO> downloadEstimateFileSource(String paId, String reportKey);
