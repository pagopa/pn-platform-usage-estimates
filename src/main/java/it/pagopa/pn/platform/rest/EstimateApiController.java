...
public class EstimateApiController implements EstimateApi {
    ...
    @Override
    public Mono<ResponseEntity<Void>> createOrUpdateEstimate(String status, String paId, String referenceMonth, Mono<EstimateCreateBody> estimate, ServerWebExchange exchange) {
